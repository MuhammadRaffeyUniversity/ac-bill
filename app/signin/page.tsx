...
export default async function SignInPage({ searchParams }: SignInPageProps) {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-muted/30 px-4 py-8 text-foreground">
      <div className="w-full max-w-sm" data-motion="page">
        ...
        <Card data-motion="panel">
          <CardHeader>
            <CardTitle>Sign in</CardTitle>
            <CardDescription>Use your internal staff account to continue.</CardDescription>
          </CardHeader>
          <CardContent>
            <form action={signInWithCredentials} className="grid gap-4" data-motion="list">
              ...
              <label className="grid gap-2 text-sm" data-motion="item">
